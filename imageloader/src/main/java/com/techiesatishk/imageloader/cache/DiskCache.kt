package com.techiesatishk.imageloader.cache
...
//Reference from https://github.com/JakeWharton/DiskLruCache
...
class DiskCache private constructor(val context: Context) : ImageCache {
    ...
    private fun writeBitmapToFile(bitmap: Bitmap, editor: DiskLruCache.Editor): Boolean { //Handling the bitmap file
